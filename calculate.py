...
parser.add_argument("-a","--add", help="adds two given numbers together")
parser.add_argument("-m","--multiply", help="multiplies two given numbers together")
